...
@property (nonatomic, strong) INString *value;					///< Must not be nil nor return YES on isNull (minOccurs = 1)
@property (nonatomic, strong) NSArray *option;					///< An array containing IndivoOption objects
